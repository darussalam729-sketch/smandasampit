Sistem Informasi Manajemen di SMAN 2 Sampit
Berikut fitur SiM yang ada:
...
6.	Jadwal PerHari
Menampilkan jadwal guru mengajar hari ini, pada jam ini di semua kelas.
Misal hari ini hari Kamis pada waktu pukul 08.40. Maka akan menampilkan jadwal mengajar semua kelas pada baris, kolomnya adalah jam pelajara ke. Kolom jamke 2 akan disorot warna (menandakan jamke 2 sedang berlangsung.

7.	Murid Tidak Hadir hari ini
...
9.	Rekap Mengajar Mingguan Guru
...
10.	Rekap KBM di Kelas perminggu
...
19.	Layanan Guru BK
Guru BK dapat meninput layanan yang sudah dilakukan, baik layanan individu, kelompok atau klasikal. Ketika tombol simpan ditekan, data layanan tersimpan di database sistem dan notif wa terkirim ke wali kelas dari murid yang diberikan layanan.
Tersedia ekspor ke xlsx untuk layanan bulan yang dipilih.

20.	Pembinaan Guru BK
...
22.	Riwayat Murid
Menampilan data log murid mencakup ketidakhadiran KBM, izin keluar/masuk atau pulang dari sekolah, layanan/pembinaan BK dan pendampingan dari guru wali.

23.	Surat Izin Guru/Pegawai
